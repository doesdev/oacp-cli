...
function PgFunc (resource) {
  console.log('made it to new PgFunc')
...
PgFunc.prototype.getColumns = function () {
  var self = this
  console.log('made it to getColumns')
...
PgFunc.prototype.setColumnObject = function (rawCols) {
  var self = this
  console.log('made it to setColumnObject')
...
PgFunc.prototype.writePgFunctions = function () {
  var self = this
  console.log('made it to writePgFunctions')
  if (self.columns.core.length === 0) return
  var resource = self.resource
  var columns = self.columns
